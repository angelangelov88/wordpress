...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211015_yourholiday_4057b1883f25ce5d6883_20211015074107_archive.zip';
	const ARCHIVE_SIZE		 = '64759800';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '4057b18-15074107';
    const SECONDARY_PACKAGE_HASH = '0356c2f-15074107';
	const VERSION			 = '1.4.3';
